...
//        basicTest();
    ...
    private static void basicTest() {
        ...
        weightMap.put("A12", 1);
        weightMap.put("A15", 8);
        ContractedBalancedWeightTree tree = new ContractedBalancedWeightTree();
    ...
    private static void randomTest() {
        ...
        System.out.println(nodeCount + " nodes with weight sum " + weightSum);

        testTree(weightMap, weightSum, tree);
    }

    private static void testTree(Map<String, Integer> weightMap, int weightSum, ContractedBalancedWeightTree tree) {
